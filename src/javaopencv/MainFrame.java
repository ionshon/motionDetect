...
//  private Mat frame = new Mat(480, 480, CvType.CV_8UC3);
//  private Mat lastFrame = new Mat(480, 704, CvType.CV_8UC3);
//  private Mat currentFrame = new Mat(480, 704, CvType.CV_8UC3);
//  private Mat processedFrame = new Mat(480, 704, CvType.CV_8UC3);
...
//    Mat2Image mat2Img = new Mat2Image();
    ...
    cap.open("rtsp://192.168.0.25:554/Master-0");
    if(!cap.isOpened()){
              ...
              if(detections >= sensibility)
              {
                ...
                if(jCheckBoxSave.isSelected())
                {
                  if(savedelay == 2)
                  {
                    ...
                    Imgcodecs.imwrite(filename, processedFrame);
                    savedelay = 0;
                  }
                  else
